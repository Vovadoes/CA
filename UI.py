...
class Variables:
    ...
    def load(self):
        self.n0 = mywindow.is_float(self.main_window.ui.doubleSpinBox_31)
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if DEDUG:
            self.ui.doubleSpinBox_31.setValue(7)  # n0
            self.ui.doubleSpinBox_32.setValue(12)  # i
            self.ui.doubleSpinBox_35.setValue(3)  # s1
            self.ui.doubleSpinBox_37.setValue(1)  # n1
            self.ui.doubleSpinBox_36.setValue(5)  # s2
            self.ui.doubleSpinBox_38.setValue(6)  # n2
    ...
    def calculate(self, fun, *args, **kwargs):
        ...
        if condition:
            self.calculation = Calculation(
                n0=self.variables.n0,
                i=self.variables.i,
                s1=self.variables.s1,
                n1=self.variables.n1,
                s2=self.variables.s2,
...
class Finish(QtWidgets.QDialog):
    def __init__(self, parent: mywindow):
        ...
        self.ui.doubleSpinBox_32.setValue(round(self.parent.calculation.s0, 1))
